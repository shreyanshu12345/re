...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Powering Personalized Credit Card Experience }
\subCode{XX367P}
...
\guideNameA{Prof. Dr. H K Krishnappa}
...
\guideNameB{Shristi Singh}
\guideDesignationB{Product Manager}
\guideDeptB{Hyperface}

%\guideNameC{Dr. Ramavenkateshwaran}
%\guideDesignationC{Professor}
%\guideDeptC{Dept. of CSE}
...
%\projectCoOrdDesigC{Professor}

% Added Ver 3.9
%% Departmental Internship co-ordinator details (internal to RVCE)
\internCoOrdNameA{Prof. P Narashimaraja}
\internCoOrdDesigA{Professor}
\internCoOrdDeptA[CSE]{Computer Science and Engineering}
